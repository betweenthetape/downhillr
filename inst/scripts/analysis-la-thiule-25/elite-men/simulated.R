...
# gtsave(
#   table_andreas_kolb,
#   "inst/scripts/analysis-la-thiule-25/elite-men/table_andreas_kolb.png",
#   zoom = 10
# )
...
#   "inst/scripts/analysis-la-thiule-25/elite-men/table_possible_faster.png",
#   zoom = 10
# )
...
# gtsave(
#   table_time_left,
#   "inst/scripts/analysis-la-thiule-25/elite-men/table_time_left.png",
#   zoom = 10
# )
...
# ggsave(
#   "inst/scripts/analysis-la-thiule-25/elite-men/plot_bump.png",
#   plot = plot_bump,
#   width = 2300,
#   height = 3200,
#   units = "px",
...
# gtsave(
#   table_heat_map,
#   "inst/scripts/analysis-la-thiule-25/elite-men/table_heat_map.png",
#   zoom = 10
# )
...
# gtsave(
#   table_combined_run,
#   "inst/scripts/analysis-la-thiule-25/elite-men/table_combined_run.png",
#   zoom = 10
# )
...
# ggsave(
#   "inst/scripts/analysis-la-thiule-25/elite-men/plot_ridges.png",
#   plot = plot_ridges,
#   width = 2200,
#   height = 1800,
#   units = "px",
...
plot_dnfs <- world_cup_25_elite_men_results |>
  ...
  theme_ridges() +
  labs(
    title = "La Thiule did not have the most DNF's, despite its reputation",
    x = "No. of DNF's",
    y = NULL
  )

# ggsave(
#   "inst/scripts/analysis-la-thiule-25/elite-men/plot_dnfs.png",
#   plot = plot_dnfs,
#   width = 2500,
#   height = 2000,
#   units = "px",
...
# TODO:
# - Add leogang to raw data for men
# - Replot below
# - insight: not as carnage as people made out? Yes more crashes, but most of
#   the racing is still in a tight-ish band that takes the same shape as most
#   races.
# Most crashes?
# Plot distributions of time_from_leader (aleady a standardized metric)
# plot_time_from_leader <-
...
# ggsave(
#   "inst/scripts/analysis-la-thiule-25/elite-men/plot_ridges_by_event.png",
...
# ggsave(
#   "inst/scripts/analysis-la-thiule-25/elite-men/plot_ronan_dunne.png",
