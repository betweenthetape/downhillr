...
#   "inst/scripts/analysis-lenzerheide-25/elite-men/table_andreas_kolb.png",
#   zoom = 10
# )
...
#   "inst/scripts/analysis-lenzerheide-25/elite-men/table_possible_faster.png",
#   zoom = 10
# )
...
# gtsave(
#   table_time_left,
#   "inst/scripts/analysis-lenzerheide-25/elite-men/table_time_left.png",
#   zoom = 10
# )
...
plot_bump <- ggplot() +
  ...
  labs(
    ...
    subtitle = "<span> Each riders fastest splits from across the Lenzerheide
...
# ggsave(
#   "inst/scripts/analysis-lenzerheide-25/elite-men/plot_bump.png",
#   plot = plot_bump,
#   width = 2300,
#   height = 3200,
#   units = "px",
...
# gtsave(
#   table_heat_map,
#   "inst/scripts/analysis-lenzerheide-25/elite-men/table_heat_map.png",
#   zoom = 10
# )
...
# gtsave(
#   table_combined_run,
#   "inst/scripts/analysis-lenzerheide-25/elite-men/table_combined_run.png",
#   zoom = 10
# )
...
# ggsave(
#   "inst/scripts/analysis-lenzerheide-25/elite-men/plot_ridges.png",
#   plot = plot_ridges,
#   width = 2200,
#   height = 1800,
#   units = "px",
...
pierron_pinkerton_times <- results |>
  filter(round_type == "Final") |>
  select(name, starts_with("split"), time) |>
  mutate(
    section_1 = split_1,
    section_2 = split_2 - split_1,
    section_3 = split_3 - split_2,
  ...
  filter(name == "Amaury Pierron" | name == "Ryan Pinkerton")

table_pierron_pinkerton <- pierron_pinkerton_times |>
  left_join(image_data) |>
  select(path, name, starts_with("section_")) |>
  gt() |>
  text_transform(
    locations = cells_body(columns = path),
    fn = function(path) {
  ...
  tab_header(
    title = md("## Could Pinkerton have beaten Pierron?"),
    subtitle = md(
      "### Sector times are shown in seconds."
    )
  ) |>
  data_color(
    columns = section_2,
